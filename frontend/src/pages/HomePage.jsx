...
import { CheckCircleIcon, MapPinIcon, UserPlusIcon, UsersIcon, Trash2Icon } from "lucide-react";
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {friends.map((friend) => (
              <FriendCard
                key={friend._id}
                friend={friend}
                onRemove={() => handleRemoveFriendFromHome(friend._id)} // pass remove handler
              />
            ))}
          </div>
        )}
